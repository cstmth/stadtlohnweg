...
new #[Title('profile_settings')] class extends Component {
...
<section class="w-full">
    ...
    <flux:heading class="sr-only">{{ __('profile_settings') }}</flux:heading>

    <x-pages::settings.layout :heading="__('profile')" :subheading="__('profile_update_sub')">
